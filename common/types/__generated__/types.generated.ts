...
export type GameRoomStatusResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['GameRoomStatus'] = ResolversParentTypes['GameRoomStatus']> = {
...
export type GameSettingsResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['GameSettings'] = ResolversParentTypes['GameSettings']> = {
...
export type PlacedShipResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['PlacedShip'] = ResolversParentTypes['PlacedShip']> = {
...
export type RoomCreatedResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['RoomCreatedResult'] = ResolversParentTypes['RoomCreatedResult']> = {
...
export type RoomJoinedResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['RoomJoinedResult'] = ResolversParentTypes['RoomJoinedResult']> = {
  roomID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  wsAuthCode?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShipResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['Ship'] = ResolversParentTypes['Ship']> = {
...
export type ShipsPlacedResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['ShipsPlacedResult'] = ResolversParentTypes['ShipsPlacedResult']> = {
...
export type UsernameQueryResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['UsernameQueryResult'] = ResolversParentTypes['UsernameQueryResult']> = {
