...
const themeDefault = {
  ...
  color100: 'white',
  color200: 'hsl(213, 69%, 94%)',
  color300: 'hsl(200, 100%, 90%)',
  color400: 'hsl(200, 100%, 50%)',
  color500: 'hsl(207, 73%, 66%)',
  color600: 'hsl(209, 81%, 50%)',
  color700: 'hsl(231, 75%, 63%)',
  color800: 'hsl(250, 73%, 65%)',
  colorLogo: '#975218',
};
