...
const getViewBox = (shipSize: number, vertical: boolean) => {
  switch (shipSize) {
    case 2:
      return vertical ? "-1 -1 22 42" : "-1 -1 42 22";
    case 3:
      return vertical ? "-1 -1 22 62" : "-1 -1 62 22";
    case 4:
      return vertical ? "-1 -1 22 82" : "-1 -1 82 22";
    case 5:
      return vertical ? "-1 -1 22 102" : "-1 -1 102 22";
    default:
      return vertical ? "-1 -1 22 22" : "-1 -1 22 22";
  }
};
